...
export const IconAnimoji1 = ({ className }) => {
  return (
    <svg
      className={`icon-animoji-1 ${className}`}
      fill="none"
      height="30"
      viewBox="0 0 40 30"
      width="40"
    ...
    >
      ...
      <g className="g" mask="url(#mask0_22_391)" />
      <defs className="defs">
        <pattern className="pattern" height="1" id="pattern0" patternContentUnits="objectBoundingBox" width="1">
          <use className="use" transform="scale(0.00833333 0.0111111)" xlink:href="#image0_22_391" />
        </pattern>
        <image
          className="image-7"
          height="90"
